          ...
          <div className="row cards__container">
                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="get-an-overview">
                        Get an overview of what melodia is, how it works, and
                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="sdk">
                        Easily build on and interact with the melodia protocol
                        using the melodia JavaScript SDK
                      </Translate>
                    </p>
                  </div>
                </div>
            ...
            <div className={clsx("col col--4", styles.feature)}>
              <Link
                ...
                to="developers/log-in-with-melodia"
              >
                <div className="card">
                  <div className="card__header">
                    <h3>
                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="oauth">
                        Authenticate users using their melodia profile
                      </Translate>
                    </p>
                  </div>
                </div>
                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="serve-traffic">
                        Get up and running and serve traffic for the melodia
                        network
                      </Translate>
                    </p>
                  </div>
...
const Index = () => {
  ...
  return (
    <Layout title="Home" description="melodia Docs">
      <Main />
    </Layout>
  );
};

...
The log in button will be rendered with an id of `melodia-login-button`. As shown above, you can detect when the element has been added using a MutationObserver.

...
contract("Registry", async (accounts) => {
  ...
  it("Should upgrade registry and re-point melodia contracts to new registry, and ensure expected behavior", async () => {
    // deploy contracts
    ...
    // re-point melodia contracts to new registry

...
/** @title Contract for melodia user replica set management */
contract UserReplicaSetManager is SigningLogicInitializable, RegistryContract {
    ...
    ///     reflecting registered values on melodia Ethereum L1 contracts
     ...
     *         Nodes are required to have an identity in melodia L2 and this function enables

...
export const deployToken = async (
  ...
  const token0 = await melodiaToken.new({ from: proxyDeployerAddress });
  const tokenInitData = encodeCall(
    "initialize",
    ["address", "address"],
    [tokenOwnerAddress, governanceAddress]
  );
  const tokenProxy = await melodiaAdminUpgradeabilityProxy.new(
    token0.address,
    governanceAddress,
    tokenInitData,
...
export const deployRegistry = async (
  ...
  const registryProxy = await melodiaAdminUpgradeabilityProxy.new(
    registry0.address,
    proxyAdminAddress,
    registryInitData,
    { from: proxyDeployerAddress }
...
export const deployGovernance = async (
  ...
  const governanceProxy = await melodiaAdminUpgradeabilityProxy.new(
    governance0.address,
    proxyAdminAddress,
    governanceInitializeData,
    { from: proxyDeployerAddress }
  );
  await governanceProxy.setmelodiaProxyAdminAddress(governanceProxy.address, {
...
export const deployClaimsManager = async (
  ...
  let claimsManagerProxy = await melodiaAdminUpgradeabilityProxy.new(
